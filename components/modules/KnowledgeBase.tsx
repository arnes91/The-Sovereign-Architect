...
const KnowledgeBase: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col p-6 relative">
      ...
      {/* Feedback Toast */}
      {copyFeedback && (
          <div className="absolute top-6 left-1/2 transform -translate-x-1/2 bg-cyber-green text-black font-bold px-4 py-2 rounded-full z-50 animate-bounce">
              {copyFeedback}
          </div>
      )}
      ...
      <div className="flex-1 overflow-hidden">
         {view === 'CREATE' ? (
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 overflow-y-auto h-full pb-10">
                 ...
                 {items.map(item => (
                     <div key={item.id} className="bg-zinc-900 border border-zinc-800 p-4 rounded hover:border-zinc-600 transition-colors group relative flex flex-col">
